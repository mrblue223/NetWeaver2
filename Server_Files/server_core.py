...
def _server_main_loop(port, log_callback, update_gui_states_callback,
                      ...
                      ssl_cert_file, ssl_key_file, max_connections): # Added max_connections
    """
    ...
    constants.MAX_CONNECTIONS = max_connections # Update the constant in server_core as well
    ...
    constants.SERVER_SOCKET.listen(constants.MAX_CONNECTIONS) # Use max_connections here
